...
// PDDL PROBLEM
problem:           LPAR DEFINE problem_def problem_domain [objects] projection depth task init_type init goal [metric_spec] [plan] RPAR
...
start: all_anceffs [domain] [problem]

cond_types: ADD | DEL | ADD_SOFT | DEL_SOFT

var: QMRK NAME

bdi_term: BELIEF | DESIRE | INTENTION

bdi: LSQB bdi_term COMMA var RSQB | LESSER_OP bdi_term COMMA var GREATER_OP

rml_options: var | list_comp_rml | atomic_formula_term_rml | gd

atomic_formula_term_rml: [EXC] bdi* [LSQB] LPAR [EXC] RML_NAME RPAR [RSQB]

anceff_params: PARAMETERS action_parameters

poscond: POSCOND pos_or_neg_cond

negcond: NEGCOND pos_or_neg_cond

atomic_formula_term_list_comp_r: [EXC] bdi* [LSQB] LPAR [EXC] R RPAR [RSQB]

list_comp_var: LCRL atomic_formula_term_list_comp_r FOR R IN var RCRL

list_comp_rml: LCRL atomic_formula_term_rml FOR AG IN AGENTS RCRL

pos_or_neg_cond_options: var | list_comp_var | atomic_formula_term_condition | gd
...
ant_def: ANT LPAR [poscond] [negcond] [awareness] rml_def cond_type_def RPAR

cons_def: CONS LPAR [poscond] [negcond] rml_def cond_type_def RPAR

atomic_formula_term_condition: [EXC] bdi* LPAR [EXC] var RPAR

awareness: AWARENESS TRUE_ | AWARENESS FALSE_

anceff: LPAR ANCEFF_NAME NAME [anceff_params] ant_def cons_def RPAR
...
derived_term: var | DLR NAME DLR

ALWAYS: "always"

NEVER: "never"

derived_conditions: ALWAYS | NEVER | LPAR predicate derived_term* RPAR
...
atomic_formula_term: [EXC] bdi* LPAR [EXC] predicate term* RPAR
...
atomic_formula_name: [EXC] problem_bdi* LPAR [EXC] predicate NAME* RPAR

problem_bdi: LSQB bdi_term COMMA NAME RSQB | LESSER_OP bdi_term COMMA NAME GREATER_OP
...
plan: LPAR PLAN gd_name* RPAR

goal: LPAR GOAL gd_name* RPAR

gd_name: atomic_formula_name | LPAR NOT atomic_formula_name RPAR | LPAR AND gd_name* RPAR | LPAR binary_comp metric_f_exp metric_f_exp RPAR
