...
class Action(object):
    ...
    def __init__(self, name, depth, agents, props, akprops, derived_cond, extra_ancillary=[]):
        ...
        for mod_name in ancillary.compute_modules() + extra_ancillary:
            ...
            if mod_name not in ["pdkb.ancillary.kd45_closure", "pdkb.ancillary.mutual_awareness"]:#, "pdkb.ancillary.negation_removal", "pdkb.ancillary.kd45_un_closure", "pdkb.ancillary.uncertain_firing"]:#["pdkb.ancillary.uncertain_firing", "pdkb.ancillary.negation_removal", "pdkb.ancillary.kd45_closure", "pdkb.ancillary.kd45_un_closure"]:
                continue
